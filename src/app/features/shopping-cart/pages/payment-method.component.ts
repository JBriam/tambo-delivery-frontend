            ...
            <form [formGroup]="cardForm" class="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  maxlength="19"
                  class="w-full text-sm text-gray-900 placeholder:text-gray-400 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#a81b8d] focus:border-transparent"
              ...
              <div class="flex items-center">
                ...
                />
                <label for="saveCard" class="ml-2 text-sm text-gray-900">
